...
const SAMPLE_PLAYERS = [
  ...
  { name: 'Rishabh Kumar', role: PLAYER_ROLES.BATSMAN, basePrice: 16, age: 25, matches: 80, speciality: 'Left-hand batsman' },
  { name: 'KL Singh', role: PLAYER_ROLES.BATSMAN, basePrice: 14, age: 29, matches: 90, speciality: 'Right-hand batsman' },
  ...
  { name: 'Ishan Kishan', role: PLAYER_ROLES.BATSMAN, basePrice: 13, age: 24, matches: 35, speciality: 'Left-hand aggressive batsman' },
